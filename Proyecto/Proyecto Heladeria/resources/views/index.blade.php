...
<body>
  ...
  <div class="navbar navbar-dark bg-dark menu float_left">
    ...
    <li class="dropdown float_right">
      ...
      <ul class="dropdown-menu bg-dark w-100"  aria-labelledby="dropdownMenuLink">
  ...
  <div class="contenido">
    <div class="side col-6">
      <img src="img/helado9.jpg" alt="Helado de Frambuesa" class="imgSide">
    </div>
  ...
  <div class="contenido">
    ...
    <div class="side col-6">
      <img src="img/helado2.png" alt="Foto de helados" class="imgSide">
    </div>
  </div>

  <div class="imgFondo2"></div>

  <div class="contenido">
    <div class="side col-6">
      <img src="img/helado10.jpg" alt="Helado de fresa" class="imgSide">
    </div>
    <div class="main col-6">
